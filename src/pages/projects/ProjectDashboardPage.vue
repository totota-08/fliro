...
import DashboardSummaryCards, { type SummaryCard } from '@/components/demo/DashboardSummaryCards.vue'
import DashboardTaskBoard, { type BoardColumn } from '@/components/demo/DashboardTaskBoard.vue'
import DemoExplainerBanner from '@/components/demo/DemoExplainerBanner.vue'
import TeamChatPreview, { type PreviewChatMessage } from '@/components/demo/TeamChatPreview.vue'
